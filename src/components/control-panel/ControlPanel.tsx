            ...
            <div id="search-area" className="ts-row">
                <div className="column is-fluid">
                    <div className="ts-input is-fluid">
                        <input type="text" className="input" placeholder="豚骨 / 雞白 / 沾麵 / 名店 / ..." />
                    </div>
                </div>
                ...
                <div className="column">
                    <button onClick={gotoLucky} className="ts-button is-icon" data-tooltip="好手氣">
                        <span className="ts-icon is-shuffle-icon"></span>
                    </button>
                </div>
            </div>
            <div id="filter-area" className="ts-wrap is-center-aligned is-middle-aligned">
                ...
                <div className="ts-modal" data-name="modal">
                    <div className="content">
                        ...
                        <div className="ts-content is-tertiary is-horizontally-padded is-end-aligned">
                            <button className="ts-button is-negative is-outlined" data-toggle="modal:is-visible">
                                確定
                            </button>
